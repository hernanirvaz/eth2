...
nat/virtual-servers/remove --ext-port-start=51413 --int-port-start=51413 --protocol=TCP/UDP --server-ip=192.168.1.28
...
nat/virtual-servers/create --ext-port-start=51413 --int-port-start=51413 --protocol=TCP/UDP --server-ip=192.168.1.28 --server-name=torrent --wan-intf=veip0.1
