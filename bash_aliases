...
eth2cp () { echo -e "\nscp $1 eth2/scripts";scp ~/eth2/t[0-8]* $1:~/eth2; }
...
alias nt='sudo iftop -i wlo1'
alias xx='exit'
alias pk='echo -e "\nscp $N eth2/keys"   ;scp ~/$D/keystore* $N:~/$D'
alias pt='echo -e "\nscp $N eth2/scripts";scp ~/eth2/t[0-8]* $N:~/eth2;ssh $N "chmod 755 ~/eth2/t*"'
